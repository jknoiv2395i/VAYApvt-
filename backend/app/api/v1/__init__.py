...
api_router.include_router(hs_codes_router, prefix="/hs-codes", tags=["HS Codes"])
...
api_router.include_router(authorize_router, prefix="/authorize", tags=["ACD Authorization"])
